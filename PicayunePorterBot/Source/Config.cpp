...
namespace Config
{
    ...
    namespace Strategy
    {
        ...
        std::string TerranStrategyName      = "Terran_Flash";
    ...
    namespace Modules							    
    {
        ...
        bool UsingGameCommander             = true;     // toggle GameCommander, effectively Picayune_Porter
    ...
    namespace Debug								
    {
        ...
        std::string ErrorLogFilename        = "PiPo_ErrorLog.txt";
