...
{
    PiPo_ASSERT(attacker, "SmartAttackUnit: Attacker not valid");
    PiPo_ASSERT(target, "SmartAttackUnit: Target not valid");
...
{
    //PiPo_ASSERT(attacker, "SmartAttackMove: Attacker not valid");
    //PiPo_ASSERT(targetPosition.isValid(), "SmartAttackMove: targetPosition not valid");
...
void Micro::SmartRightClick(BWAPI::Unit unit, BWAPI::Unit target)
{
    ...
    PiPo_ASSERT(target, "SmartRightClick: Target not valid");
...
{
    PiPo_ASSERT(rangedUnit, "SmartKiteTarget: Unit not valid");
    PiPo_ASSERT(target, "SmartKiteTarget: Target not valid");
...
{
    PiPo_ASSERT(muta, "MutaDanceTarget: Muta not valid");
    PiPo_ASSERT(target, "MutaDanceTarget: Target not valid");
