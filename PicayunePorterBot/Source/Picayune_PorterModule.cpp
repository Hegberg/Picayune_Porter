...
#include "Common.h"
#include "Picayune_PorterModule.h"
#include "JSONTools.h"
...
void Picayune_PorterModule::onStart()
{
	...
	//ParseUtils::ParseConfigFile("E:\GamesForSchool\Picayune_Porter\Picayune_Porter\Picayune_Porter_Config.txt");
...
void Picayune_PorterModule::onEnd(bool isWinner) 
{
	if (Config::Modules::UsingGameCommander)
	{
...
void Picayune_PorterModule::onFrame()
{
	//BWAPI::Broodwar->printf("Christopher Hegberg 1402494");
